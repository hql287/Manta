          ...
          <h1 key="paymentTerm">{' '}
            {
              invoice.dueDate.useCustom
                ? moment(invoice.dueDate.selectedDate).lang(language).format(configs.dateFormat)
                : moment(calTermDate(invoice.created_at, invoice.dueDate.paymentTerm)).lang(language).format(configs.dateFormat)
            }
          </h1>,
          <h2 key="dueDateNote">
            {
              ...
              ${t(`form:fields:dueDate:paymentTerms:${invoice.dueDate.paymentTerm}:description`)}
