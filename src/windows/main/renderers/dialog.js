...
// Custom Libs
const sounds = require('@uiLibs/sounds.js')

const centerOnPrimaryDisplay = require('@uiHelpers/center-on-primary-display')

function openDialog(dialogOptions, returnChannel = '', ...rest) {
  const width = 450
  const height = 220
