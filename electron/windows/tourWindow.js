...
const devURL = 'http://localhost:5173/windows/tour/index.html'
...
export const createTourWindow = async () => {
  ...
  console.log('Preload Path: ', path.join(__dirname, './preloads/tour.js'))
  ...
  tourWindow = new BrowserWindow({
    ...
    webPreferences: {
      preload: path.join(__dirname, './preloads/tour.mjs'),
